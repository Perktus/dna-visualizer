...
glm::vec3 nucleotideColor(Nucleotide n) {
    switch (n) {
        case Nucleotide::A: return { 0.95f, 0.26f, 0.21f }; // czerwony
        case Nucleotide::T: return { 0.13f, 0.59f, 0.95f }; // niebieski
        case Nucleotide::G: return { 0.30f, 0.69f, 0.31f }; // zielony
        case Nucleotide::C: return { 1.00f, 0.76f, 0.03f }; // żółty
    }
